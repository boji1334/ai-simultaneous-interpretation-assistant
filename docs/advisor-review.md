...
这份文档用于给导师快速判断项目是否符合题目方向、是否值得继续打磨，以及最终提交前还应注意什么。
...
- 比赛规则核对：[competition-audit.md](competition-audit.md)
- 最终提交清单：[submission-checklist.md](submission-checklist.md)
...
- 最大展示风险：如果有时间，真人录音旁白会比 TTS 更有说服力；当前视频已使用更自然的神经网络中文旁白。
